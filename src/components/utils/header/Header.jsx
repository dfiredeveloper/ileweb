...
import logo from '../../../assets/svgs/lems.svg'
      ...
      <div id='header'>
        <div className="header_wrapper">
          <div className="logo_container">
            <a href="https://lems.dev"><img src={logo} alt="Lems logo"/></a>
          </div>
              ...
              <div className="mobile_menu_container">
                ...
                <h3>Connect With Me</h3>
                  <div className="social_icons">
                    <a href="https://github.com/dfiredeveloper"><i className='fab fa-github'></i></a> 
                    <a href="https://twitter.com/ileachimugu"><i className='fab fa-twitter'></i></a>
                    <a href="https://ng.linkedin.com/in/samuelachimugu"><i className="fab fa-linkedin"></i></a>
                  </div>
                </div>
              </div>
            </nav>
